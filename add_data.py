...
with app.app_context():
    ...
    books_data = [
        {'id': 12, 'title': 'Hundred years of solitude', 'author_name': 'Gabriel', 'author_surname': 'Garcia Marquez', 'original_language': 'Spanish', 'translation_language': 'English', 'first_publication': '1967', 'genre': 'Magic realism, Family saga, Literary fiction', 'month': 'April', 'year': 2020, 'cover_image': 'book_covers/book-12.svg'},
        ...
        {'id': 18, 'title': 'Demian', 'author_name': 'Herman', 'author_surname': 'Hesse', 'original_language': 'German', 'translation_language': 'English', 'first_publication': '1919', 'genre': 'Bildungsroman, Psychological fiction, Philosophical fiction', 'month': 'June', 'year': 2018, 'cover_image': 'book_covers/book-18.svg'},
        ...
        {'id': 29, 'title': 'The Little Prince', 'author_name': 'Antoine', 'author_surname': 'de Saint-Exupery', 'original_language': 'French', 'translation_language': 'English', 'first_publication': '1943', 'genre': 'Novella, Fable, Philosophical fiction', 'month': 'August', 'year': 2015, 'cover_image': 'book_covers/book-29.svg'},
